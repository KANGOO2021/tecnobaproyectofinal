...
<body>
	...
	<header>
		...
		fixed-top"data-bs-theme="dark">
			<div class="container-fluid row">
				...
				<div class="titulo col-sm-4 col-md-1 col-5">
					<h1>TecnoBA</h1>
				</div>
				...
				<div
					class="collapse navbar-collapse col-sm-2 col-md-8 col-3 justify-content-end"
					id="navbarNav">
					<ul class="navbar-nav">
						<li class="nav-item"><img id="micuenta" title="Mi cuenta"
							src="assets/portada/user2.png"
						...
						<li class="nav-item"><a
							class="nav-link active btn btn-light text-black btn-lg ms-2"
	...
	<main>
						...
						<div class="card" id="card">
							<div class="card-body position-relative">
								...
								<a href="#" class="btn btn-dark btn-add-cart boton-producto "
									data-id="<%=e.getIdProducto()%>">Añadir al carrito</a> 
									<input type="hidden" class="form-control stockActual"
									value="<%=e.getCantidad()%>">
							</div>
						</div>
					</div>
		...
		<section class="suscripcion " id="contacto">
			...
			<form action="" method="" class="my-3 needs-validation was-validated"
				novalidate>
				<div class="mb-2">
